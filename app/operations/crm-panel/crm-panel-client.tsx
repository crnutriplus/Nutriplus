...
const customerStatusLabels: Record<string, string> = { PROSPECT: "Prospecto", CUSTOMER: "Cliente", RECURRING: "Cliente recurrente", INACTIVE: "Inactivo" };
const orderStatusLabels: Record<string, string> = { DRAFT: "Borrador", CONFIRMED: "Confirmado", PREPARED: "Preparado", DELIVERED: "Entregado", CANCELLED: "Cancelado", REOPENED: "Reabierto" };
const customerStatusLabel = (value: string) => customerStatusLabels[value] ?? value;
const orderStatusLabel = (value: string) => orderStatusLabels[value] ?? value;
