...
type Expense = { id: string; date: string; category: string; categoryLabel: string; description: string; amountCrc: number; originalAmountMinor: number; exactOriginalAmount: number; currency: string; paymentMethod: string; provider: string | null; routeId: string | null; orderId: string | null; sourceType: string; sourceId: string | null; entryType: string; businessScope: string };
