...
const migration = await readFile(
  new URL("../drizzle/0022_meta_capi_outbox.sql", import.meta.url),
  "utf8",
);
...
console.log(
  "Migration 0022 adds the durable Meta CAPI outbox, enforces dedupe/check constraints, and preserves existing data",
);
