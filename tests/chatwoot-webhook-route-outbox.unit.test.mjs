...
test("the receiver bootstraps only its outbox, persists valid work, rejects invalid signatures, and deduplicates without synchronous Chatwoot API work", async () => {
